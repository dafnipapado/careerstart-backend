    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, AuthenticationProvider authenticationProvider) throws Exception {
        http
                ...
                .authorizeHttpRequests(request -> request
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/jobseekers/{uuid}/activate").hasAuthority("ROLE_ADMIN")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/jobseekers/{uuid}/avatar-upload", "/api/v1/jobseekers/{uuid}/cv-upload").hasAuthority("UPDATE_JOB_SEEKER")
                        .requestMatchers(HttpMethod.GET, "/api/v1/jobseekers/{uuid}/avatar", "/api/v1/jobseekers/{uuid}/cv").hasAuthority("VIEW_JOB_SEEKER")
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/job-listings/{uuid}/restore").hasAuthority("ROLE_ADMIN")
